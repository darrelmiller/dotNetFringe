...
namespace GitLinksConsole
{
    public class Given_a_GitHub_ClientState
    {
        ...
        public async Task Get_a_user()
        {
            ...
            var results = _clientstate.List.Select(s => UserLink.InterpretMessageBody(s)).Where(u => u.Hireable && u.Followers > 50).ToList();
        ...
        public async Task Search_for_some_code()
        {
            ...
            var count = CodeSearchLink.InterpretMessageBody(searchResults);
